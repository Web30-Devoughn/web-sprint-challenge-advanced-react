...
You need to set up a constructor containing state
2. Describe the different phases of the component lifecycle.
the mounting phase is where components are being built and constructor/render is invoked.

updating phase is where you can change state.

un-mounting phase is where you remove component from page.
3. Demonstrate an understanding of class component lifecycle methods.
these methods are called during specific points throughout the lifecycle
4. Define stateful logic.
Stateful logic is code that uses state. more specifically, hooks.
5. Describe how to test a React component with React Testing Library.
import react ,anything you need from the testing library and the component you want to test.then render the component in test with the tests you wnt to run.
